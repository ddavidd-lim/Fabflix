...
|------------------------------------------------|------------------------------|----------------------------|-------------------------------------|---------------------------|--------------|
| Case 1: HTTP/1 thread                          | ![](imgs/case1HTTP_1_thread.png)  | 27                         | 10.618427945814194             | 10.23943828920971         | ??           |
| Case 2: HTTP/10 threads                        | ![](imgs/case2HTTP_10_threads.png)   | 104                         | 85.45868345411533          | 85.19410142339412         | ??           |
